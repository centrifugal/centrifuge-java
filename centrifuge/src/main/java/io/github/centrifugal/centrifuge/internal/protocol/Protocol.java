...
public final class Protocol {
  ...
  public  static final class Command extends
    ...
    public io.github.centrifugal.centrifuge.internal.protocol.Protocol.MethodType getMethod() {
      io.github.centrifugal.centrifuge.internal.protocol.Protocol.MethodType result = io.github.centrifugal.centrifuge.internal.protocol.Protocol.MethodType.forNumber(method_);
     ...
     */
    private void setMethod(io.github.centrifugal.centrifuge.internal.protocol.Protocol.MethodType value) {
  ...
  public  static final class Push extends
    ...
    public io.github.centrifugal.centrifuge.internal.protocol.Protocol.PushType getType() {
      io.github.centrifugal.centrifuge.internal.protocol.Protocol.PushType result = io.github.centrifugal.centrifuge.internal.protocol.Protocol.PushType.forNumber(type_);
     ...
     */
    private void setType(io.github.centrifugal.centrifuge.internal.protocol.Protocol.PushType value) {
  ...
  public  static final class Unsub extends
      com.google.protobuf.GeneratedMessageLite<
          Unsub, Unsub.Builder> implements
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          io.github.centrifugal.centrifuge.internal.protocol.Protocol.Unsub, Builder> implements
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new io.github.centrifugal.centrifuge.internal.protocol.Protocol.Unsub();
        }
        case NEW_BUILDER: {
          return new Builder();
        }
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<io.github.centrifugal.centrifuge.internal.protocol.Protocol.Unsub> parser = PARSER;
          if (parser == null) {
            synchronized (io.github.centrifugal.centrifuge.internal.protocol.Protocol.Unsub.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<io.github.centrifugal.centrifuge.internal.protocol.Protocol.Unsub>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
    ...
    static {
      Unsub defaultInstance = new Unsub();
      // New instances are implicitly immutable so no need to make
      // immutable.
      DEFAULT_INSTANCE = defaultInstance;
      com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
        Unsub.class, defaultInstance);
    }
    ...
    private static volatile com.google.protobuf.Parser<Unsub> PARSER;
  ...
  public  static final class Sub extends
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          io.github.centrifugal.centrifuge.internal.protocol.Protocol.Sub, Builder> implements
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new io.github.centrifugal.centrifuge.internal.protocol.Protocol.Sub();
        }
        case NEW_BUILDER: {
          return new Builder();
        }
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<io.github.centrifugal.centrifuge.internal.protocol.Protocol.Sub> parser = PARSER;
          if (parser == null) {
            synchronized (io.github.centrifugal.centrifuge.internal.protocol.Protocol.Sub.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<io.github.centrifugal.centrifuge.internal.protocol.Protocol.Sub>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
    ...
    static {
      Sub defaultInstance = new Sub();
      // New instances are implicitly immutable so no need to make
      // immutable.
      DEFAULT_INSTANCE = defaultInstance;
      com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
        Sub.class, defaultInstance);
    }
    ...
    private static volatile com.google.protobuf.Parser<Sub> PARSER;
  ...
  public  static final class SubscribeResult extends
    ...
    private void ensurePublicationsIsMutable() {
      if (!publications_.isModifiable()) {
        publications_ =
            com.google.protobuf.GeneratedMessageLite.mutableCopy(publications_);
       }
    }
